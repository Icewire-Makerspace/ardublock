...
public class ZumoLineRightBlock extends TranslatorBlock
{

	public ZumoLineRightBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret;
		ret = "(reflectanceSensors.readLine(sensors) > 3000)\n";
